        ...
        >
            {!isLoaded ? (
                <div className="relative w-full h-full">
                    ...
                    <button 
                        onClick={handlePlay}
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-yellow-500 hover:bg-yellow-400 text-white font-bold py-4 px-6 rounded-full flex items-center"
                    >
            ...
            <button 
                ...
                } bg-yellow-500 hover:bg-yellow-400 text-white font-bold py-2 px-4 rounded flex items-center`}
            >
                {isFullscreen ? (
                    <>
